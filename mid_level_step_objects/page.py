...
class RegistrationPage:
    ...
    @allure.step("Вводим адрес, штат, город")
    ...
    @allure.step("Проверяем, что имя и фамилия заполнены")
